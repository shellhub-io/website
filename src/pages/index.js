  ...
  return <Layout>
    ...
    <SectionSuccessStyle>
      <div className="container">
        ...
        <div className="text">
          <p>Every  successful software is adapted to its users needs. The best way to adapt the software forits users needs is allowing its users to directly influence its development and direction, thus open-sourcing ShellHub was the obvious choice.</p>
